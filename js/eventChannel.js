    ...
    lpConfig = {
      ...
      success: function (response) {
        ...
        if (responseEvent) {
          ...
          // grab session id
          sessionID = responseEvent.events.eventList[0].eventObject.resourceURL.split('/')[4];
          // grab state
          state = responseEvent.events.eventList[0].eventObject.state;
          // publish event
          ATT.event.publish(sessionID + '.responseEvent', responseEvent);
        }
