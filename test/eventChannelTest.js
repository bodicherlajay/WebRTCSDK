...
describe.only('Event Channel', function () {
  ...
  describe('Event Channel factory method', function () {
    ...
    it('should throw error if the config options are invalid', function () {
      ...
      expect(ATT.createEventChannel.bind(ATT, channelConfig)).to.throw('Invalid Options. Cannot create channel.');
    });
    ...
    it('should call `addOperation` to the resourceManager', function () {
