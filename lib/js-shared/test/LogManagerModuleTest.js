...
describe('LogManagerModule', function () {
  ...
  describe('Log Manager Singleton', function () {
    ...
    describe('Methods', function () {
      describe('addLoggerForModule', function () {
        expect(logManager.addLoggerForModule).is.a('function');
      });
      describe('getLoggerByName', function () {
        expect(logManager.getLoggerByName).is.a('function');
      });
      describe('updateLogLevel', function () {
        expect(logManager.updateLogLevel).is.a('function');
      });
    });
    ...
    describe('Logger', function () {
      ...
      it('should log a DEBUG message with filename and line number', function () {
        ...
        logger.logDebug(theMessage);
        expect(spy.calledWithMatch('LogManagerModuleTest.js:67')).to.equal(true);
        console.log.restore();
      });
