...
describe('Event emitter', function () {
  ...
  describe('Methods', function () {
    ...
    describe('subscribe', function () {
      ...
      it('should add a subscriber to the topic');
    });
    ...
    describe('unsubscribe', function () {
      ...
      it('should remove a topic when the last subscriber unsubscribes');
      it('should remove the subscriber from an existing topic');
